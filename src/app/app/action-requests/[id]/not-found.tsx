  ...
  return (
    <section className="mx-auto max-w-3xl px-5 py-16 sm:px-8">
      ...
      <h1 className="mt-3 text-3xl font-semibold tracking-tight text-zinc-950">
        This request is not available in the local demo database.
      </h1>
      <p className="mt-4 text-sm leading-6 text-zinc-600">
        Go back to the queue to choose a real action request, or run the local
        smoke scripts to generate fresh demo records.
      </p>
